...
class ClassMatcherKt(matcher: ClassMatcher) : TypeMatcherKt<ClassMatch, ClassMatcher>(
    matcher
) {
...
class StringMatcherKt(matcher: StringMatcher) : BaseMatcherKt<StringMatch, StringMatcher>(
    matcher
) {
    var exact: String
        @Deprecated(
...
class FieldMatcherKt(matcher: FieldMatcher) : MemberMatcherKt<FieldMatch, FieldMatcher>(
    matcher
) {
    var name: StringMatchKt
        @Deprecated(
...
class MethodMatcherKt(matcher: MethodMatcher) : ExecutableMatcherKt<MethodMatch, MethodMatcher>(
    matcher
) {
    var name: StringMatchKt
        @Deprecated(
...
class ClassMatchKt(match: ClassMatch) : TypeMatchKt<ClassMatchKt, ClassMatch>(match) {
...
class MethodMatchKt(match: MethodMatch) : ExecutableMatchKt<MethodMatchKt, MethodMatch, Method>(
    match
) {
    val name: StringMatchKt
        inline get() = StringMatchKt(match.name)
...
class FieldMatchKt(match: FieldMatch) : MemberMatchKt<FieldMatchKt, FieldMatch, Field>(
    match
) {
    val name: StringMatchKt
        inline get() = StringMatchKt(match.name)
...
class StringMatchKt(match: StringMatch) : BaseMatchKt<StringMatchKt, StringMatch, String>(match)
...
) = HookBuilderKt.MatchResultKt(buildHooks(this, classLoader, sourcePath) {
